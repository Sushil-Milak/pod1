...
// original: uncomment once basic pod works
/*
struct VFMPMainViewR: View {
    //   let chat: Chat
    //  @Binding var path: NavigationPath // pass the path as a binding
   // @State var isPoliciesOpen: Bool
    ...
    func checkCameraPermission() {
        ...
        /*
         ...
         DispatchQueue.main.async{
         print("Before What is camera status: \(cameraPermissionGranted), \(showSettingsAlert)")
         ...
         print("After What is camera status: \(cameraPermissionGranted), \(showSettingsAlert)")
         }
         */
    }
...
//                                            .padding(.bottom).padding(.top)
            ...
            .onAppear{
                ...
                Analytics.logEvent(AnalyticsEventScreenView,
                                   parameters: [AnalyticsParameterScreenName: "\(VFMPMainView.self)",
                                               AnalyticsParameterScreenClass: "\(VFMPMainView.self)"])
